            ...
            <div className="row">
                <div className="col-12">
                    <div className="skill-bx wow zoomIn">
                        <h2>Skills</h2>
                        <p>I had done MERN Stack and MEAN Stack course where .<br></br> I learned Html, Css, Core Javascript React, Node, Express, Angular, Mongodb, Mongoose.</p>
